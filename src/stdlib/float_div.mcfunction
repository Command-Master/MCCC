...
execute if score $expa namespace matches 0 run function namespace:float_div1
execute if score $expb namespace matches 0 run function namespace:float_div2

execute if score $r namespace matches 0 run function namespace:float_div3