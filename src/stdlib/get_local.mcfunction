...
execute if score $search1 namespace = $stackSize namespace run function namespace:tree/local_get
execute if score $search1 namespace < $stackSize namespace run function namespace:tree/local_copy
execute if score $search1 namespace < $stackSize namespace run function namespace:tree/templ_get