...
execute if score $expdiff namespace matches 0 run function namespace:sub_mags1
execute unless score $expdiff namespace matches 0 run function namespace:sub_mags2